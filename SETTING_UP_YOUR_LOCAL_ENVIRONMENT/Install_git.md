...
* For Debian/Ubuntu/Ubuntu-derivatives based distro, you also need the `install-info` package.
...
* (Optionally) You can configure the default text editor that'll be used when Git needs you to type in a message using:
<br />`git config --global core.editor <editor_name>`.
